...
const Contact = () => {
  ...
  const handleWhatsApp = () => {
    ...
    const message = encodeURIComponent(
      "Hello Sholztech, I would like to inquire about your courses."
    );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div>
              ...
              <h1 className="text-3xl font-extrabold text-[#1B263B] mb-4">
                Let's Start Your Journey to Tech Mastery
              </h1>
              <p className="text-gray-600">
                Have questions about our training programs? Reach out to us
                today.
              </p>
            </div>
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white rounded-lg shadow-sm text-[#778DA9]">
                  <MapPin size={24} />
                </div>
                <div>
                  <h4 className="font-bold text-blue-900">Our Location</h4>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-100">
              ...
              <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  } text-white font-bold py-4 rounded-lg flex items-center justify-center gap-2 transition-all duration-300`}
                >
                  <Send size={20} />
